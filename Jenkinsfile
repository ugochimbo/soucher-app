    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                sh 'sudo -u www-data cp -R ./asset/css /srv/www/soucher/app'
                sh 'sudo -u www-data cp -R ./asset/font /srv/www/soucher/app'
                sh 'sudo -u www-data cp -R ./asset/js /srv/www/soucher/app'
